...
\----------------------------------------------------------------------/
   ...
   File:       PMPLAINPackageDataProvider.h
...
#ifndef PMPLAINPackageDataProvider_h
#define PMPLAINPackageDataProvider_h
...
class PMPLAINPackageDataProvider : virtual public Rep, public PMPackageDataProvider
{
  ...
  public:
    ...
    */
    PMPLAINPackageDataProvider( constInstSrcDataPLAINPtr instSrc_r,
...
#endif // PMPLAINPackageDataProvider_h
