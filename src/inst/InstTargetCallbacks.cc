...
///////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////////////////
  ScriptExecReport scriptExecReport;

  void ScriptExecCallback::start( const Pathname & pkpath ) {
  }
  bool ScriptExecCallback::progress( const ProgressData & prg ) {
    return true; // continue execution
  }
  void ScriptExecCallback::stop( PMError error ) {
  }
