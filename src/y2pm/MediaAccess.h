...
class MediaAccess : virtual public Rep {
	 ...
	 *
         * If the directory contains a file "directory.yast", the content of
         * this file will be returned as directory listing. This file can be
         * generated by "ls >directory.yast". The directory file itself, as well
         * as the "." and ".." entries will be ignored.
         *
